...
public class NearestClone {
   ...
   *
   */
  static int findShortest(int graphNodes, int graphEdges, int[] graphFrom, int[] graphTo,
      long[] ids, int val) {
  ...
  public static void main(String[] args) throws IOException {
    File file = new File(
        "C:\\Users\\darre_000\\eclipse-workspace\\HackerRank\\unsolved\\NearestClone\\input0.txt");
